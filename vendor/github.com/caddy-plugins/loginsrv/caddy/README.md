...
Login plugin for Caddy, based on [tarent/loginsrv](https://github.com/caddy-plugins/loginsrv).
...
For a full documentation of loginsrv configuration and usage, visit the [loginsrv README.md](https://github.com/caddy-plugins/loginsrv).

A small demo can be found in the [./demo](https://github.com/caddy-plugins/loginsrv/tree/master/caddy/demo) directory.
