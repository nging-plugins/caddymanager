...
type Slice_NgingVhostServer = factory.Slicex[*NgingVhostServer]
...
func (a *NgingVhostServer) CtxFrom(source factory.Model) factory.Model {
...
func (a *NgingVhostServer) List(recv interface{}, mw func(db.Result) db.Result, page, size int, args ...interface{}) (func() int64, error) {
	...
	if err == nil {
		...
		case *[]*NgingVhostServer:
			err = a.base.FireReaded(a, queryParam, Slice_NgingVhostServer(*v))
		case []*NgingVhostServer:
			err = a.base.FireReaded(a, queryParam, Slice_NgingVhostServer(v))
		case factory.Ranger:
...
func (a *NgingVhostServer) Clone() *NgingVhostServer {
	cloned := NgingVhostServer{Id: a.Id, Engine: a.Engine, Environ: a.Environ, Ident: a.Ident, Name: a.Name, ExecutableFile: a.ExecutableFile, Endpoint: a.Endpoint, ConfigLocalFile: a.ConfigLocalFile, ConfigContainerFile: a.ConfigContainerFile, VhostConfigLocalDir: a.VhostConfigLocalDir, VhostConfigContainerDir: a.VhostConfigContainerDir, CertLocalDir: a.CertLocalDir, CertContainerDir: a.CertContainerDir, CertAutoRenew: a.CertAutoRenew, WorkDir: a.WorkDir, Env: a.Env, CmdWithConfig: a.CmdWithConfig, ConfigFileUpdated: a.ConfigFileUpdated, AutoModifyConfig: a.AutoModifyConfig, EndpointTlsCert: a.EndpointTlsCert, EndpointTlsKey: a.EndpointTlsKey, CertPathFormatKey: a.CertPathFormatKey, CertPathFormatCert: a.CertPathFormatCert, CertPathFormatTrust: a.CertPathFormatTrust, Disabled: a.Disabled, Created: a.Created, Updated: a.Updated}
	cloned.CtxFrom(a)
	return &cloned
}
...
func (a *NgingVhostServer) Validate(column string, value interface{}) error {
	return a.base.Validate(a, column, value)
}

func (a *NgingVhostServer) TrimOverflowText(column string, value string) string {
